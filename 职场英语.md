...
---
## Unit 3
### Workplace Ettiquette for New Stuff
#### Everyday Workplace Ettiquette
- Make a good impression
- Arrive early 
#### Telephone Ettiquette
- Avoid checking phone in public
- Turn phone to slient mode on meeting
- Do not check phone when having a face to face conversation
#### Meeting Ettiquette
- Be on time
- Be prepared
- Be a good listener
...
- Do not pass out your card to everyone you meet
- Do not write on someone's card
- Do not offer card with left hand
- After Receive the card, do not put it away without looking at it
- Read the card and say the name aloud

#### Speed Reading Skills
- Skipping
    - Decide whether continue to read
- Skimming
    - Get the main idea
- Scanning
...
- Effective teleconference
    ...
    - Take up minimum time
    - Follow sensible process
- Meeting leader
    - Welcome people
    - Order the turn
    - Call on by name
...
- Heading
    - First line
    - Bold
    - To: Address the recipants formally
        - Full name + job title
        - All empolyees
...
- Body
    ...
    - Give context for the issue 
    - Support your course of action
    - Suggest actions
    - Close with a positive and warm summary
- Finalize
    - Format
        - 12 pt font
        - 1 inch margin
        - Block style, double space between paragraphs
        - No indent
    - Proofread
    - Handwrite initial by your name
    - Use memo letterhead 
